...
function QuoteGenerator() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      <div className="max-w-lg p-8 bg-slate-900/80  rounded-lg shadow-xl shadow-black">
        ...
        <button
          className="mt-8 px-4 py-2 text-2xl font-bold
           bg-gray-800 text-white rounded
            hover:bg-gray-700 focus:outline-none
             focus:ring-2 focus:ring-gray-400 w-[400px] ml-4"
